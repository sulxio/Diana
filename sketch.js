...
function draw() {
  ...
  //variable = variable +1; expands with increase of + __ smaller number the slower/ high number the faster 
  
  fill(249,184,229,100); //  (the last number refers to transparency (min. 0, max. 255)
  stroke(221,209,243);//lavender
  strokeWeight(5);
  rect(mouseX,mouseY,40,100); //horizontal,vertical,width,length
  line(variable,variable,250,250);
